...
import { LogInResponse, SuccessfulLoginResponseDto } from './models';
...
function LogIn() {
	...
	let onLogIn = () => {
		update(() => {
			...
			backend.get<SuccessfulLoginResponseDto>(
				...
				.then(resp => {
					...
					//localStorage.setItem("userTitle", data.userTitle.toString());
					//localStorage.setItem("authJwt", data.jwt.toString());
